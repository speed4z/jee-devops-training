package com.lab10.app;

import java.util.List;
import java.util.Scanner;
import com.lab10.entities.Employee;
import com.lab10.services.EmployeeService;
import com.lab10.services.EmployeeServiceImpl;
...
public class EmployeeCRUD {
		...
		public static void main(String[] args) {
			...
			case 4:List <Employee> lst1 = (service.listAllEmployee());
				for(Employee e : lst1) {
			...
			case 5:
					...
					List <Employee> lst2 =service.sortlistAllEmployee();
					for(Employee e : lst2) {
						System.out.println(e);
					}
				break;
